...
(
    ...
    ACCOUNTUSERID INT NOT NULL UNIQUE,
...
DROP TABLE IF EXISTS AUDIT_USERHISTORY
-- Create a new table called 'AUDIT_USERHISTORY' in schema '
-- Drop the table if it already exists
DROP TABLE IF EXISTS AUDIT_USERHISTORY

-- Create the table in the specified schema
CREATE TABLE AUDIT_USERHISTORY
(
    USERID INT,
    MEDIAID INT,
